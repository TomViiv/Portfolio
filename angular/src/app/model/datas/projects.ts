...
export const myProjects: Project[] = [
  new Project(
    'Bureau de rêves',
    '06 . 2023',
    "Suite à un MOOC Blender effectué en Mars 2023, j'ai modélisé mon \"Bureau de rêve\" en 3D sur Blender. L'objectif suivant est de l'intégrer à ce portfolio à l'aide de la librarie ThreeJs.",
    [
  ...
  new Project('KUHN AURA Live', "depuis 2021", "Actuellement, je suis en alternance en tant qu'ingénieur Full-Stack au sein de l'équipe robotique de l'entreprise KUHN Audureau. J'ai en charge de la réalisation de l'application KUHN AURA Live. Je réalise les maquettes de vues et je les implémente. Je m'occupe aussi de la partie BackEnd. KUHN AURA Live est une application Angular destinée à être l'Interface Homme Machine principale de l'innovant robot KUHN AURA.",
    ...
    [
      ...
      {
        type: 'img', name:'Missions réalisées', url: '/assets/Projects/AURA_Live/past-missions.png'
      },
      {
    ...
    [
      {
        type: 'img',
        name: 'Face avant',
        url: '/assets/Projects/Arduino/digital-lock-face.png',
      },
      {
        type: 'img',
        name: 'Intérieur - Arduino',
        url: '/assets/Projects/Arduino/digital-lock-inside.png',
      },
      {
        type: 'img',
        name: 'Intérieur - Batterie',
        url: '/assets/Projects/Arduino/digital-lock-battery.png',
      },
      {
        type: 'video',
        name: 'Premiers tests',
